						...
						<div className="text-center lg:text-left">
							<div className="space-y-6">
								<h1 className="text-4xl md:text-5xl font-bold text-black dark:text-white mb-6">
									Bienvenido de vuelta a <span className="gradient-text">NexU</span>
								</h1>
								<p className="text-xl text-black/90 dark:text-white/90 mb-8 max-w-lg mx-auto lg:mx-0">
									Inicia sesión para continuar explorando lugares increíbles cerca de tu universidad
								</p>
								<div className="space-y-4">
									<div className="flex items-center space-x-3 text-gray-800 dark:text-white/80">
										...
										<span>Descubre lugares recomendados por la comunidad</span>
									</div>
									<div className="flex items-center space-x-3 text-gray-800 dark:text-white/80">
										<div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
											<span className="text-sm">💰</span>
										</div>
										<span>Ahorra tiempo y dinero con tips universitarios</span>
									</div>
									<div className="flex items-center space-x-3 text-gray-800 dark:text-white/80">
										<div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center">
											<span className="text-sm">🤝</span>
