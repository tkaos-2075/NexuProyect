...
6. **Mapa interactivo**: Visualización de los lugares en un mapa dinámico gracias a la API de Google Maps.
   - Componente principal: `src/components/dashboard/InteractiveMap.tsx`. Permite buscar, visualizar y agregar lugares directamente sobre el mapa, así como crear planes desde la interfaz del mapa. Usa TailwindCSS para la mayoría de estilos.
...
### AddPlaceForm
- **Ubicación:** `src/components/dashboard/AddPlaceForm.tsx`
- **Propósito:** Formulario para agregar un nuevo lugar (comida o diversión) con soporte para modo oscuro, selección de etiquetas, validaciones y uso de TailwindCSS para estilos. Utiliza alias de importación para mantener el código limpio y escalable.
